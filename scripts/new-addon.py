...
def main():
    ...
    parser.add_argument('--template', choices=['hello', 'commands', 'panel_settings', 'menu_hooks', 'note_import', 'picker_notes', 'editor_watch', 'live_status'], default='hello')
    ...
    if not source.is_dir():
        source = root / 'examples/source' / args.template
    sample = (source / f'{args.template}.cpp').read_text(encoding='utf-8')
    manifest = (source / 'addon.ini').read_text(encoding='utf-8')
